    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('Doctor', 'Doctor'), ('Patient', 'Patient')], max_length=50, null=True)),
                ('specialities', models.CharField(choices=[('MS', 'MS'), ('MD', 'MD'), ('Dentist', 'Dentist'), ('Physiotherapist', 'Physiotherapist')], max_length=20)),
